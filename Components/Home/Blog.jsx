        ...
        <div className="flex justify-center items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-9 h-full lg:w-5/6 mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden w-full">
              <Image
                src="/assets/Blog/b1.jpeg" // Use your actual image path
                alt="Quality online courses"
                width={500} // Define width for optimization
                height={300} // Define height for optimization
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden w-full">
              <Image
                src="/assets/Blog/b2.jpeg" // Use your actual image path
              ...
              <div className="p-6 bg-blue-gray-50">
                <p className="text-sm text-gray-500 mb-2">ASK Project • June 3, 2024</p>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">
                  Increase your skill in no time
                </h3>
                <p className="text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                  venenatis odio...
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden w-full">
              <Image
                src="/assets/Blog/b6.jpeg" // Use your actual image path
