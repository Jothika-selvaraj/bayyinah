...
const Section1 = () => {
  const courses = [
    ...
    },
    {
      id: 2,
      price: "Quran Hifz",
      img: "/assets/Course/Islamic course.png", // Updated for Next.js public path
      title: "Quran Hifz",
            ...
            >
              ...
              <div className="relative">
                <div className="w-[240px] h-[200px]">
                  <Image
                    src={course.img} // Using Image component
                    alt={course.title}
                    width={240} // Define width
                    height={200} // Define height
                    className="object-cover" // Adjust to object-fit
                  />
                </div>
                <div className="absolute -left-4 bottom-5 bg-[#f14d5d] text-white text-md px-4 py-3">
                  {course.price}
                </div>
              </div>

              {/* Hover Content */}
              <div className="absolute inset-0 bg-white flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 ease-in duration-500">
                ...
                <a
                  href="/course-list"
                  className="text-sm font-bold bg-[#f14d5d] text-white px-4 py-2 rounded hover:bg-[#f14d5d] transition"
                >
                  Join Now
                </a>
              </div>
