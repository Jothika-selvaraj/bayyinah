      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 mb-8 lg:mb-0 pl-6 lg:pl-28 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
            <button className="bg-[#F14D5D] text-white hover:bg-[white] hover:text-black px-6 py-3 rounded-md">
              Find Course
            </button>
            <button className="bg-white hover:bg-[#F14D5D] text-black hover:text-white px-6 py-3 rounded-md">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] lg:w-[500px] lg:h-[400px] relative overflow-hidden rounded-b-full">
            <Image
              src="/assets/Header/homebann.jpg" // Use your actual image URL
              alt="Children learning Quran"
              width={500} // Define width (same as the final size)
              height={400} // Define height (same as the final size)
