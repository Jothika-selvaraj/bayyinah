...
const Header = () => {
  return (
    <header className="bg-white shadow-md py-8 px-2">
        ...
        <div className="logo pl-4">
          <Link href="/">
            <Image
              ...
              alt="Logo"
              width={100} // Set the appropriate width for the logo
              height={40} // Set the appropriate height for the logo
              className="h-auto"
            />
          </Link>
        </div>
        ...
        <nav className="flex justify-center items-center space-x-6">
          <ul className="list-none p-0 flex gap-6">
            ...
            <li className="relative group">
              ...
              <ul className="absolute text-center mt-2 w-35 bg-white shadow-lg rounded-md z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                <li>
            ...
            {/* More Dropdown */}
            <li className="relative group">
              <button className="text-black text-lg hover:text-[#f14d5d] focus:outline-none">
                More
              </button>
              {/* Dropdown for More */}
              <ul className="absolute text-left w-36 bg-white shadow-lg rounded-md z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                <li>
                ...
                <li>
                  <Link href="/testimonials" className="block px-4 py-2 text-black hover:bg-gray-100">
                    Testimonials
                  </Link>
                </li>
                <li>
                  <Link href="/teachers" className="block px-4 py-2 text-black hover:bg-gray-100">
                    Teachers
                  </Link>
                </li>
                <li>
            ...
            {/* Cart Icon */}
            <li className="relative group">
              <Link href="/cart" className="text-black text-lg hover:text-[#f14d5d] flex items-center space-x-2">
                <span>Cart</span>
